package com.model.concurrents.exceples.example4;

import com.model.concurrents.exceples.example4.interfaces.ServiceInter;
...
public class FileOperUtils {
    ...
    public static void reader(){
        try {
            ...
            ServiceInter service=new PutDataToQueue();
            int num=0;
